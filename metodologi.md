...
Tahap EDA sangat penting untuk:
- Memahami distribusi dan karakteristik data log
- Mengidentifikasi outlier dan pola anomali awal
- Visualisasi fitur penting  
EDA membantu merancang fitur dan mendukung validitas proses pemodelan selanjutnya.
